                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      required
                      disabled={isLoading || isUploading}
                      className="block w-full rounded-sm border border-gray-300 bg-white px-4 py-2.5 text-gray-900 transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/10 disabled:bg-gray-50"
                    >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="block w-full rounded-sm border border-gray-300 bg-white px-4 py-2.5 pr-10 text-gray-900 transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/10 disabled:bg-gray-50"
                        placeholder="••••"
                      />
                      <button
                        type="button"
